                  ...
                  <div className="card-body p-3">
                    <ul className="nav flex-column">
                      ...
                      <li className="nav-item mb-2">
                        ...
                        >
                          <i className="bi bi-chevron-right me-2"></i>Data
                          Collection
                        </a>
                      </li>
                      <li className="nav-item mb-2">
                        <a className="nav-link text-dark" href="#data-use">
                          <i className="bi bi-chevron-right me-2"></i>Use of
                          Information
                        </a>
                      </li>
                      <li className="nav-item mb-2">
                      ...
                      <li className="nav-item mb-2">
                        <a className="nav-link text-dark" href="#rights">
                          <i className="bi bi-chevron-right me-2"></i>Your
                          Rights
                        </a>
                      </li>
              ...
              <div className="card border-0 shadow-sm mb-4">
                <div className="card-body p-4 p-md-5">
                  <div className="mb-5" id="introduction">
                    ...
                    <p>
                      At LegalEase, we take your privacy seriously. This Privacy
                  ...
                  <div className="mb-5" id="data-collection">
                    ...
                    <div className="mb-4">
                      ...
                      <p>
                        If you make purchases through our services, we collect
                        payment information such as credit card numbers and
                        billing addresses.
                      </p>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <p>
                        We automatically collect information on how you interact
                        with our services, including IP address, browser type,
                        pages visited, and other diagnostic data.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="card-body">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="mb-0">
                              We may share your information with service
                              providers to monitor and analyze the use of our
                              service, to process payments, etc.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-md-6 mb-4">
                        <div className="card h-100 border-0 shadow-sm">
                          <div className="card-body text-center p-4">
                            ...
                            <p className="mb-0">
                              Strict access controls limit who can view or
                      ...
                      <div className="col-md-6 mb-4">
                        <div className="card h-100 border-0 shadow-sm">
                          <div className="card-body p-4">
                            ...
                            <p className="mb-0">
                              <a
                                href="mailto:privacy@legalease.com"
                                className="text-decoration-none"
                              >
                                privacy@legalease.com
                              </a>
                            </p>
                          </div>
                        </div>
