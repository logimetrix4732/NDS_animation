...
const directors = [
  ...
  },
  {
    ...
    bio: [
      ...
      "Dr. Krishnan has demonstrated expertise across multiple domains, including Sales & Marketing, Strategy & Planning, IT & MIS, and Business Excellence.",
      "His career spans key roles with NDDB Dairy Services, PricewaterhouseCoopers, and the Kerala Livestock Development Board, where he contributed significantly to organizational growth and operational efficiency.",
    ],
    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "#0f0f0f", py: 8 }}>
      <Container maxWidth="lg">
        ...
        <Grid container spacing={3} justifyContent="center" sx={{ mb: 2 }}>
          ...
          >
            <StyledCard backgroundImage={featured.fullImage}>
              <CardContent
                sx={{
                  p: 4,
                  display: "flex",
