...
const serviceItems = [
  {
    ...
    desc: "From idea to execution, the agency helps startups design, develop, and launch software products, apps, and platforms. Focus on user-centric design (UI/UX) to ensure an engaging",
  },
  {
    img: service_4_2,
