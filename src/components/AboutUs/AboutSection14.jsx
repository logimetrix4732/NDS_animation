...
const ChairmanSection = () => {
  ...
  const chairmanMessage = {
    ...
    content: [
      "From its humble beginnings in 2009, in just fifteen years NDS has managed to transform itself to the changing needs. Starting with just two verticals of facilitating Producer Organizations and Productivity Enhancement Services, today the mandate of NDS has expanded to supply of Animal Nutrition products, implementation of Artificial Insemination (AI)/ Embryo Transfer (ET) projects and initiatives around sustainability.",
      "As on 31st March 2025, the 23 MPOs facilitated by NDS were covering over 37,375 villages in 206 districts spread across ten States, having a membership base of 12.71 lakh and procuring an average volume of around 62 lakh kg per day of milk during the year. With a firm commitment to inclusion and women led development, 16 out of the 23 MPOs have an all-women membership and all the producer–Directors on their respective Boards are women. The chairperson of 18 of the 23 MPOs are women and women members constitute 77% of the total membership base of all the MPOs put together. Plans are also in place to cover an additional 7000 villages next year increasing the milk procurement by 8 lakh litres per day from an additional 2 lakh members, 1.56 lakh of whom will be women.",
