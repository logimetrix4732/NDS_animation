...
import bgMilk from "../../Images/MilkProducerImg/bgMilk.png";
import bgMilk1 from "../../Images/MilkProducerImg/bgMilk1.png";
    ...
    <div className="position-relative overflow-hidden space">
      <div className="cta-sec6 theme-bg position-relative overflow-hidden">
        <div className="container">
          <div className="row">
            <div
              className="col-md-6 col-lg-6 position-relative overflow-hidden"
              style={{ zIndex: 1 }}
            >
              {/* BOTTOM Background Image - bgMilk1 */}
              <img
                src={bgMilk}
