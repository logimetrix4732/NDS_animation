!(function (e) {
        ...
        !(function t() {
          requestAnimationFrame(t),
            document.querySelectorAll(".single").forEach((t) => {
              ...
              (t.style.transform = `translate(0, ${n}px) rotate(${
                -i * e.rotate
              }deg)`),
        ...
        e(document).on(
          ...
          function () {
            ...
            if (a.length) {
              var i = a[0].swiper;
              i &&
                (e(this).data("slider-prev") ? i.slidePrev() : i.slideNext());
            }
          }
        );
    }),
  ...
  function h(t, a, i, n) {
    e(document).on("click", a, function (a) {
      ...
      e(document).on("click", function (i) {
        e(i.target).closest(t).length ||
          e(i.target).closest(a).length ||
          e(t).removeClass(n);
      }),
  ...
  if ((new WOW().init(), e(".reveal").length)) {
    gsap.registerPlugin(ScrollTrigger),
      document.querySelectorAll(".reveal").forEach((e) => {
        ...
        a.set(e, { autoAlpha: 1 }),
          a.from(e, 1, { xPercent: -100, ease: Power2.out }),
          a.from(t, 1, {
            xPercent: 100,
            scale: 1,
            delay: -1,
  ...
  if (e(".text-anime-style-1").length) {
    ...
    document.querySelectorAll(".text-anime-style-1").forEach((a) => {
      ...
      gsap.from(i.words, {
        ...
        autoAlpha: 0,
        stagger: e,
        scrollTrigger: { trigger: a, start: "top 85%" },
      });
    });
  }
  if (e(".text-anime-style-2").length) {
    ...
    document.querySelectorAll(".text-anime-style-2").forEach((n) => {
      let s = new SplitText(n, { type: "chars, words" });
      gsap.from(s.chars, {
        duration: 2,
        delay: a,
        x: t,
  ...
  const g = document.querySelector(".slider-drag-cursor"),
    m = { x: window.innerWidth / 2, y: window.innerHeight / 2 },
    f = { x: m.x, y: m.y },
    v = gsap.quickSetter(g, "x", "px"),
    w = gsap.quickSetter(g, "y", "px");
  function b(e) {
  ...
  window.addEventListener("pointermove", (e) => {
    ...
    gsap.ticker.add(() => {
      ...
      (m.x += (f.x - m.x) * e), (m.y += (f.y - m.y) * e), v(m.x), w(m.y);
    }),
    e(document)
  ...
  function A() {
    P ||
      (window.innerWidth > 991
        ? (S ||
            ((S = new Lenis({ lerp: 0.07 })),
            S.on("scroll", ScrollTrigger.update),
            gsap.ticker.add((e) => {
              S.raf(1e3 * e);
            }),
