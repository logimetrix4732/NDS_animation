        ...
        >
            ...
            >
                <form onSubmit={(e) => e.preventDefault()}>
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Tender Title</label>
                        <TextField
                            fullWidth
                            size="small"
                            variant="outlined"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Reference Number</label>
                        <TextField
                            fullWidth
                            size="small"
                            variant="outlined"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Start Date</label>
                        <TextField
                            fullWidth
                            size="small"
                            type="date"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Estimated Value</label>
                        <TextField
                            fullWidth
                            size="small"
                            variant="outlined"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Location</label>
                        <TextField
                            fullWidth
                            size="small"
                            variant="outlined"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Pre-Bid Meeting</label>
                        <TextField
                            fullWidth
                            size="small"
                            type="datetime-local"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Last Date of Submission</label>
                        <TextField
                            fullWidth
                            size="small"
                            type="datetime-local"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Bid Opening</label>
                        <TextField
                            fullWidth
                            size="small"
                            type="datetime-local"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Corrigendum Status</label>
                        <TextField
                            select
                            fullWidth
                            size="small"
                    ...
                    <Box sx={{ mb: 2 }}>
                        <label style={{ color: "#1d2640", display: "block", marginBottom: "8px" }}>Tender Card Status</label>
                        <TextField
                            select
                            fullWidth
                            size="small"
